...
class TestXunitParser(UnitTest):
...
<testsuites>
 ...
 AssertionError: 13 != 14
    ...
    def test_bogus_lines(self):
        ...
        self.assertEqual('Invalid first line identifier', str(cm.exception))

    def test_nothing_tested(self):
        parser = XUnitParser()

        self.assertEqual({'__summary__': {'FAILED': 0, 'SKIPPED': 0, 'SUCCESS': 0, Constants.FAILURES_COUNT: False}}, parser.parse(['XUnit', '<testsuites></testsuites>']))
